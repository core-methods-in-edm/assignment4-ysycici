...
```{r}
D1 <- read.csv("/Users/cici/assignment4-ysycici/Assistments-confidence.csv", header=TRUE)
...
### Yes. Important information about mean_correct is lost.The negative correlation of mean_correct is missing after dropping one component.
...
```{r}
P1 <- read.csv("/Users/cici/assignment4-ysycici/humor_data.csv", header=TRUE)
library(dplyr)
P2 <- P1[,1:32]
library(corrplot)
COR4 <- cor(P2)
